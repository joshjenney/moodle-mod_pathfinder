 ...
 *
 * Description:	Displays all Pathfinder instances.
 *
...
##
if (! $pathfinders = get_all_instances_in_course('pathfinder', $course)) {
    notice(get_string('pathfinder_notfound_instances', 'pathfinder'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
##
...
foreach ($pathfinders as $pathfinder) {
    ...
    if ($course->format == 'weeks' or $course->format == 'topics') {
        $table->data[] = array($pathfinder->section, $link);
    } else {
        $table->data[] = array($link);
    }
}

echo $OUTPUT->heading(get_string('pathfinder_found_instances', 'pathfinder'), 2);
